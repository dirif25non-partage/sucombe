...
Quand il s'agit d'un tunnel, le champ lieu permet de l'identifier, mais, hors tunnel, ce champs prend la valeur SIRIUS. On pourrait ajouter des choix de lieux plus spécifiques tels que les axes où se situent les équipements concernés.
